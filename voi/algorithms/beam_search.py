...
def beam_search(inputs,
    ...
    """Perform a beam search using the autoregressive decoder Transformer
    ...
    def update(inputs, closed, last_beam_size, i):
        ...
        return [inputs, closed, last_beam_size, i]

    def cond(inputs, closed, last_beam_size, i):
    ...
    outputs, closed, last_beam_size, i = tf.while_loop(
        cond,
        update,
        [inputs, closed, last_beam_size, i],
        shape_invariants=[
            [
